...
/**
 * Wrap Connection gốc để intercept việc tạo PreparedStatement.
 * Mọi câu SQL đều đi qua đây trước khi thực thi.
 */
public class QualityConnection implements Connection {

  private final Connection original;
  private final SQLContext sqlContext;
  private final QualityConfig config;

  public QualityConnection(Connection original, SQLContext sqlContext, QualityConfig config) {
  ...
  public PreparedStatement prepareStatement(String sql) throws SQLException {
    return new QualityPreparedStatement(
        original.prepareStatement(sql), sql, sqlContext, config);
  }
  ...
  public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
    return new QualityPreparedStatement(
        original.prepareStatement(sql, autoGeneratedKeys),
        sql, sqlContext, config);
  }
  ...
  public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
    return new QualityPreparedStatement(
        original.prepareStatement(sql, columnIndexes),
        sql, sqlContext, config);
  }
  ...
  public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
    return new QualityPreparedStatement(
        original.prepareStatement(sql, columnNames),
        sql, sqlContext, config);
  }
  ...
  @Override
  public Clob createClob() throws SQLException { return original.createClob(); }

  @Override
  public Blob createBlob() throws SQLException { return original.createBlob(); }

  @Override
  public NClob createNClob() throws SQLException { return original.createNClob(); }

  @Override
  public SQLXML createSQLXML() throws SQLException { return original.createSQLXML(); }

  @Override
  public boolean isValid(int timeout) throws SQLException { return original.isValid(timeout); }
  ...
  @Override
  public void setSchema(String schema) throws SQLException { original.setSchema(schema); }

  @Override
  public String getSchema() throws SQLException { return original.getSchema(); }

  @Override
  public void abort(Executor executor) throws SQLException { original.abort(executor); }
  ...
  @Override
  public int getNetworkTimeout() throws SQLException { return original.getNetworkTimeout(); }

  @Override
  public <T> T unwrap(Class<T> iface) throws SQLException { return original.unwrap(iface); }
